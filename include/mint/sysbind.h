/*
 * ./gen-syscall, Thu Mar 19 22:40:29 2015
 *
...
#define Srealloc(a) trap_1_wl(0x15,(long)a)
#define Slbopen(a,b,c,d,e) trap_1_wlllll(0x16,(long)a,(long)b,(long)c,(long)d,(long)e)
#define Slbclose(a) trap_1_wl(0x17,(long)a)
...
#define Sconfig(a,b) trap_1_wwl(0x33,(short)a,(long)b)
...
#define Syield() trap_1_w(0xff)
#define Fpipe(a) trap_1_wl(0x100,(long)a)
#define Ffchown(a,b,c) trap_1_wwww(0x101,(short)a,(short)b,(short)c)
#define Ffchmod(a,b) trap_1_www(0x102,(short)a,(short)b)
#define Fsync(a) trap_1_ww(0x103,(short)a)
#define Fcntl(a,b,c) trap_1_wwlw(0x104,(short)a,(long)b,(short)c)
#define Finstat(a) trap_1_ww(0x105,(short)a)
#define Foutstat(a) trap_1_ww(0x106,(short)a)
#define Fgetchar(a,b) trap_1_www(0x107,(short)a,(short)b)
#define Fputchar(a,b,c) trap_1_wwlw(0x108,(short)a,(long)b,(short)c)
#define Pwait() trap_1_w(0x109)
#define Pnice(a) trap_1_ww(0x10a,(short)a)
#define Pgetpid() trap_1_w(0x10b)
#define Pgetppid() trap_1_w(0x10c)
#define Pgetpgrp() trap_1_w(0x10d)
#define Psetpgrp(a,b) trap_1_www(0x10e,(short)a,(short)b)
#define Pgetuid() trap_1_w(0x10f)
#define Psetuid(a) trap_1_ww(0x110,(short)a)
#define Pkill(a,b) trap_1_www(0x111,(short)a,(short)b)
#define Psignal(a,b) trap_1_wwl(0x112,(short)a,(long)b)
#define Pvfork() trap_1_w(0x113)
#define Pgetgid() trap_1_w(0x114)
#define Psetgid(a) trap_1_ww(0x115,(short)a)
#define Psigblock(a) trap_1_wl(0x116,(long)a)
#define Psigsetmask(a) trap_1_wl(0x117,(long)a)
#define Pusrval(a) trap_1_wl(0x118,(long)a)
#define Pdomain(a) trap_1_ww(0x119,(short)a)
#define Psigreturn() trap_1_w(0x11a)
#define Pfork() trap_1_w(0x11b)
#define Pwait3(a,b) trap_1_wwl(0x11c,(short)a,(long)b)
#define Fselect(a,b,c,d) trap_1_wwlll(0x11d,(short)a,(long)b,(long)c,(long)d)
#define Prusage(a) trap_1_wl(0x11e,(long)a)
#define Psetlimit(a,b) trap_1_wwl(0x11f,(short)a,(long)b)
#define Talarm(a) trap_1_wl(0x120,(long)a)
#define Pause() trap_1_w(0x121)
#define Sysconf(a) trap_1_ww(0x122,(short)a)
#define Psigpending() trap_1_w(0x123)
#define Dpathconf(a,b) trap_1_wlw(0x124,(long)a,(short)b)
#define Pmsg(a,b,c) trap_1_wwll(0x125,(short)a,(long)b,(long)c)
#define Fmidipipe(a,b,c) trap_1_wwww(0x126,(short)a,(short)b,(short)c)
#define Prenice(a,b) trap_1_www(0x127,(short)a,(short)b)
#define Dopendir(a,b) trap_1_wlw(0x128,(long)a,(short)b)
#define Dreaddir(a,b,c) trap_1_wwll(0x129,(short)a,(long)b,(long)c)
#define Drewinddir(a) trap_1_wl(0x12a,(long)a)
#define Dclosedir(a) trap_1_wl(0x12b,(long)a)
#define Fxattr(a,b,c) trap_1_wwll(0x12c,(short)a,(long)b,(long)c)
#define Flink(a,b) trap_1_wll(0x12d,(long)a,(long)b)
#define Fsymlink(a,b) trap_1_wll(0x12e,(long)a,(long)b)
#define Freadlink(a,b,c) trap_1_wwll(0x12f,(short)a,(long)b,(long)c)
#define Dcntl(a,b,c) trap_1_wwll(0x130,(short)a,(long)b,(long)c)
#define Fchown(a,b,c) trap_1_wlww(0x131,(long)a,(short)b,(short)c)
#define Fchmod(a,b) trap_1_wlw(0x132,(long)a,(short)b)
#define Pumask(a) trap_1_ww(0x133,(short)a)
#define Psemaphore(a,b,c) trap_1_wwll(0x134,(short)a,(long)b,(long)c)
#define Dlock(a,b) trap_1_www(0x135,(short)a,(short)b)
#define Psigpause(a) trap_1_wl(0x136,(long)a)
#define Psigaction(a,b,c) trap_1_wwll(0x137,(short)a,(long)b,(long)c)
#define Pgeteuid() trap_1_w(0x138)
#define Pgetegid() trap_1_w(0x139)
#define Pwaitpid(a,b,c) trap_1_wwwl(0x13a,(short)a,(short)b,(long)c)
#define Dgetcwd(a,b,c) trap_1_wlww(0x13b,(long)a,(short)b,(short)c)
#define Salert(a) trap_1_wl(0x13c,(long)a)
#define Tmalarm(a) trap_1_wl(0x13d,(long)a)
#define Psigintr(a,b) trap_1_www(0x13e,(short)a,(short)b)
#define Suptime(a,b) trap_1_wll(0x13f,(long)a,(long)b)
#define Ptrace(a,b,c,d) trap_1_wwwll(0x140,(short)a,(short)b,(long)c,(long)d)
#define Mvalidate(a,b,c,d) trap_1_wwlll(0x141,(short)a,(long)b,(long)c,(long)d)
#define Dxreaddir(a,b,c,d,e) trap_1_wwllll(0x142,(short)a,(long)b,(long)c,(long)d,(long)e)
#define Pseteuid(a) trap_1_ww(0x143,(short)a)
#define Psetegid(a) trap_1_ww(0x144,(short)a)
#define Pgetauid() trap_1_w(0x145)
#define Psetauid(a) trap_1_ww(0x146,(short)a)
#define Pgetgroups(a,b) trap_1_wwl(0x147,(short)a,(long)b)
#define Psetgroups(a,b) trap_1_wwl(0x148,(short)a,(long)b)
#define Tsetitimer(a,b,c,d,e) trap_1_wwllll(0x149,(short)a,(long)b,(long)c,(long)d,(long)e)
#define Dchroot(a) trap_1_wl(0x14a,(long)a)
#define Fstat64(a,b,c) trap_1_wwll(0x14b,(short)a,(long)b,(long)c)
#define Fseek64(a,b,c,d,e) trap_1_wllwwl(0x14c,(long)a,(long)b,(short)c,(short)d,(long)e)
#define Dsetkey(a,b,c,d) trap_1_wlllw(0x14d,(long)a,(long)b,(long)c,(short)d)
#define Psetreuid(a,b) trap_1_www(0x14e,(short)a,(short)b)
#define Psetregid(a,b) trap_1_www(0x14f,(short)a,(short)b)
#define Sync() trap_1_w(0x150)
#define Shutdown(a) trap_1_wl(0x151,(long)a)
#define Dreadlabel(a,b,c) trap_1_wllw(0x152,(long)a,(long)b,(short)c)
#define Dwritelabel(a,b) trap_1_wll(0x153,(long)a,(long)b)
#define Ssystem(a,b,c) trap_1_wwll(0x154,(short)a,(long)b,(long)c)
#define Tgettimeofday(a,b) trap_1_wll(0x155,(long)a,(long)b)
#define Tsettimeofday(a,b) trap_1_wll(0x156,(long)a,(long)b)
#define Tadjtime(a,b) trap_1_wll(0x157,(long)a,(long)b)
#define Pgetpriority(a,b) trap_1_www(0x158,(short)a,(short)b)
#define Psetpriority(a,b,c) trap_1_wwww(0x159,(short)a,(short)b,(short)c)
#define Fpoll(a,b,c) trap_1_wlll(0x15a,(long)a,(long)b,(long)c)
#define Fwritev(a,b,c) trap_1_wwll(0x15b,(short)a,(long)b,(long)c)
#define Freadv(a,b,c) trap_1_wwll(0x15c,(short)a,(long)b,(long)c)
#define Ffstat64(a,b) trap_1_wwl(0x15d,(short)a,(long)b)
#define Psysctl(a,b,c,d,e,f) trap_1_wllllll(0x15e,(long)a,(long)b,(long)c,(long)d,(long)e,(long)f)
#define Semulation(a,b,c,d,e,f,g,h,i) trap_1_wwwlllllll(0x15f,(short)a,(short)b,(long)c,(long)d,(long)e,(long)f,(long)g,(long)h,(long)i)
#define Fsocket(a,b,c) trap_1_wlll(0x160,(long)a,(long)b,(long)c)
#define Fsocketpair(a,b,c,d) trap_1_wllll(0x161,(long)a,(long)b,(long)c,(long)d)
#define Faccept(a,b,c) trap_1_wwll(0x162,(short)a,(long)b,(long)c)
#define Fconnect(a,b,c) trap_1_wwll(0x163,(short)a,(long)b,(long)c)
#define Fbind(a,b,c) trap_1_wwll(0x164,(short)a,(long)b,(long)c)
#define Flisten(a,b) trap_1_wwl(0x165,(short)a,(long)b)
#define Frecvmsg(a,b,c) trap_1_wwll(0x166,(short)a,(long)b,(long)c)
#define Fsendmsg(a,b,c) trap_1_wwll(0x167,(short)a,(long)b,(long)c)
#define Frecvfrom(a,b,c,d,e,f) trap_1_wwlllll(0x168,(short)a,(long)b,(long)c,(long)d,(long)e,(long)f)
#define Fsendto(a,b,c,d,e,f) trap_1_wwlllll(0x169,(short)a,(long)b,(long)c,(long)d,(long)e,(long)f)
#define Fsetsockopt(a,b,c,d,e) trap_1_wwllll(0x16a,(short)a,(long)b,(long)c,(long)d,(long)e)
#define Fgetsockopt(a,b,c,d,e) trap_1_wwllll(0x16b,(short)a,(long)b,(long)c,(long)d,(long)e)
#define Fgetpeername(a,b,c) trap_1_wwll(0x16c,(short)a,(long)b,(long)c)
#define Fgetsockname(a,b,c) trap_1_wwll(0x16d,(short)a,(long)b,(long)c)
#define Fshutdown(a,b) trap_1_wwl(0x16e,(short)a,(long)b)
#define Pshmget(a,b,c) trap_1_wlll(0x170,(long)a,(long)b,(long)c)
#define Pshmctl(a,b,c) trap_1_wlll(0x171,(long)a,(long)b,(long)c)
#define Pshmat(a,b,c) trap_1_wlll(0x172,(long)a,(long)b,(long)c)
#define Pshmdt(a) trap_1_wl(0x173,(long)a)
#define Psemget(a,b,c) trap_1_wlll(0x174,(long)a,(long)b,(long)c)
#define Psemctl(a,b,c,d) trap_1_wllll(0x175,(long)a,(long)b,(long)c,(long)d)
#define Psemop(a,b,c) trap_1_wlll(0x176,(long)a,(long)b,(long)c)
#define Psemconfig(a) trap_1_wl(0x177,(long)a)
#define Pmsgget(a,b) trap_1_wll(0x178,(long)a,(long)b)
#define Pmsgctl(a,b,c) trap_1_wlll(0x179,(long)a,(long)b,(long)c)
#define Pmsgsnd(a,b,c,d) trap_1_wllll(0x17a,(long)a,(long)b,(long)c,(long)d)
#define Pmsgrcv(a,b,c,d,e) trap_1_wlllll(0x17b,(long)a,(long)b,(long)c,(long)d,(long)e)
#define Maccess(a,b,c) trap_1_wllw(0x17d,(long)a,(long)b,(short)c)
#define Fchown16(a,b,c,d) trap_1_wlwww(0x180,(long)a,(short)b,(short)c,(short)d)
#define Fchdir(a) trap_1_ww(0x181,(short)a)
#define Ffdopendir(a) trap_1_ww(0x182,(short)a)
#define Fdirfd(a) trap_1_wl(0x183,(long)a)
...
#define Dbmsg(a,b,c) trap_14_wwwl(0xb,(short)a,(short)b,(long)c)
...
#define EsetShift(a) (void)trap_14_ww(0x50,(short)a)
...
#define VsetMask(a,b) (short)trap_14_www(0x96,(short)a,(short)b)
#define CacheCtrl(a,b) trap_14_www(0xa0,(short)a,(short)b)
#define WdgCtrl(a) trap_14_ww(0xa1,(short)a)
#define ExtRsConf(a,b,c) trap_14_wwwl(0xa2,(short)a,(short)b,(long)c)
#define Waveplay(a,b,c,d) trap_14_wwlll(0xa5,(short)a,(long)b,(long)c,(long)d)
